...
function OrderPage({ params }) {
	...
	useEffect(() => {
		...
		if (
			...
			fetchOrder()
			//hide paypal button when payment is made
			if (successPay) {
				dispatch({ type: 'PAY_RESET' })
			}
			//hide delivery button when is delivered
			if (successDeliver) {
	...
	//!EVENT HANDLER FOR PAYPAL BUTTON
	//*create order
	...
	function onAprove(data, actions) {
		...
		return actions.order.capture().then(async function (details) {
			try {
				...
				//update status to paid in backend db
				...
				//notify frontend that payment is successfull
	...
	//!EVENT HANDLER FOR DELIVER FUNCTION
